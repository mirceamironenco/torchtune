...
from torchtune.models.qwen3._component_builders import lora_qwen3, qwen3, qwen3_moe
...
def qwen3_moe_30b_a3b_base() -> TransformerDecoder:
    """
    Builder for creating a Qwen3 MoE 30B-A3B base model initialized w/ the default parameter values
    from https://huggingface.co/Qwen/Qwen3-30B-A3B-Base

    Returns:
        TransformerDecoder: Instantiation of Qwen3 MoE 30B-A3B base model
    """
    return qwen3_moe(
        vocab_size=151936,
        num_layers=48,
...
def qwen3_moe_30b_a3b_instruct() -> TransformerDecoder:
    """
    Builder for creating a Qwen3 MoE 30B-A3B instruct model initialized w/ the default parameter values
    from https://huggingface.co/Qwen/Qwen3-30B-A3B

    Returns:
        TransformerDecoder: Instantiation of Qwen3 MoE 30B-A3B instruct model
    """
    return qwen3_moe(
        vocab_size=151936,
        num_layers=48,
